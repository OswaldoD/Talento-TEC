                                  ...
                                  <div class="col-md-12">
                                        ...
                                        <form class="form" role="form" method="post" action="login" accept-charset="UTF-8" id="login-nav">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control" id="input_password" placeholder="Contraseña" required />
                                            </div>
                                            <div class="checkbox">
                                                <label>
    ...
    <div class="container"> 
        ...
        <footer class="footer">
            <div class="container">
                ...
                <div class="row-fluid">
                <div class="col-md-4"> <p class="text-white"> <a href="../Footer/TerminosUso.aspx"> Términos de Uso </a> </p> </div>
                <div class="col-md-4"> <p><a href="../Footer/FechasImportantes.aspx"> Fechas Importantes </a> </p></div>
                <div class="col-md-4"> <p><a href="../Footer/Contactenos.aspx"> Contáctenos </a> </p></div>
