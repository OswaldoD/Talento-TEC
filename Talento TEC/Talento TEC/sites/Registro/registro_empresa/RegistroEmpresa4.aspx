<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistroEmpresa4.aspx.cs" Inherits="Talento_TEC.sites.Registro.registro_empresa.RegistroEmpresa4" %>
...
<!-- ---------------------------------------------------------------------------------------------------------------------------------- -->
    ...
    <div class="container">
        ...
        <h3>Finalización</h3>
        <br />
        <p>Su registro ha sido exitoso. Recibirá una notificación en el correo electrónico proporcionado cuando su inscripción sea autorizada.</p>
        <form class="form-horizontal" role="form" method="post" action="RegistroEmpresa2.aspx" accept-charset="UTF-8" id="form_1">
            ...
            <div class="form-group">
                ...
                <button type="submit" class="btn btn-primary btn-md col-md-1" formaction="../../../MainInterface.aspx">Finalizar</button> 
